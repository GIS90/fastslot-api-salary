...
base_info:
    __author__ = PyGo
    __time__ = 2026/7/12 15:09
    __version__ = v.1.0.0
    __mail__ = gaoming971366@163.com
    __blog__ = www.pygo2.top
    __project__ = fastslot-api-salary
    __file_name__ = system_config_task.py
...
__all__ = ["XtbUserTaskAddModel", "XtbUserTaskUpdateModel"]


class __XtbUserTaskBaseModel(baseModel):
...
class XtbUserTaskAddModel(__XtbUserTaskBaseModel):
...
class XtbUserTaskUpdateModel(__XtbUserTaskBaseModel):
