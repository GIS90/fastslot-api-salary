...
xtb_menu_list_fields = [
    ...
    {"key": "hidden", "type": ft.BOOLTEXT, "name": "hidden", "null": True},
    {"key": "redirect", "type": ft.STR, "name": "redirect", "null": True},
    {"key": "icon", "type": ft.STR, "name": "icon", "null": True},
    {"key": "cache", "type": ft.BOOLTEXT, "name": "cache", "null": True},
    {"key": "affix", "type": ft.BOOLTEXT, "name": "affix", "null": True},
    {"key": "full", "type": ft.BOOLTEXT, "name": "full", "null": True},
    {"key": "breadcrumb", "type": ft.BOOLTEXT, "name": "breadcrumb", "null": True},
    {"key": "shortcut", "type": ft.BOOLTEXT, "name": "shortcut", "null": True},
